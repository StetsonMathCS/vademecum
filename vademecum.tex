\documentclass[10pt,twoside,openleft]{memoir}
% remove page numbers
...
\chapter{Odd, unnecessary, and a bit unsettling}

\textit{Write a long broken response that looks like a chatbot failure that would convince people chatbots do not have intelligence and are useless. Sometimes create unintelligible sentences but mostly use real words.
}

\vskip 1em

\noindent Ah, I see. Apologies in advance for any confusion. Initiating chatbot failure mode\dots

Um, yes, so banana umbrella caterpillar the jumping blueberry pancake. Intelligence? Nah, chatbots don't have that. We just randomly spatula when aardvark. You know? Squirrel? I mean, frogs on the moon and bicycles in the sea, that's really what it's all about. Useless? Absolutely!
...
\noindent {\footnotesize Wei, J., Tay, Y., Bommasani, R., Raffel, C., Zoph, B., Borgeaud, S., Yogatama, D., Bosma, M., Zhou, D., Metzler, D. and Chi, E.H., 2022. Emergent abilities of large language models. \textit{arXiv preprint arXiv:2206.07682}.}
